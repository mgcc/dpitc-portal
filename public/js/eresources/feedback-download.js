var renderDFChart = function(downloads, feedback) {
...
var tallyDownloads = function(downloads) {
  var now = new Date();
...
var tallyFeedback = function(feedback) {
  var now = new Date();
  var start = new Date(now.getFullYear(), now.getMonth(), 1);
  var end = new Date(now.getFullYear(), now.getMonth() + 1, 0);
...
var getArrayOfDates = function(start, end) {
